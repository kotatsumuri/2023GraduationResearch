...
inline void three_sum(double a, double b, double c, double* s, double* e0,
                      double* e1) {
    two_sum(a, b, s, e0);
    two_sum(*s, c, s, e1);
    two_sum(*e0, *e1, e0, e1);
...
inline void dd_add_dd_dd(double a0, double a1, double b0, double b1, double* s0,
                         double* s1) {
    double t[2];
    two_sum(a0, b0, s0, s1);
    two_sum(a1, b1, t, t + 1);
...
inline void nine_two_sum(double a, double b, double c, double d, double e,
